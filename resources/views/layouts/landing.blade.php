        ...
        <div class="row">
            <div class="col-xl-6 col-lg-7 col-lg-7">
                <div class="intro-contain">
                    <div>
                        <h1 class="wow fadeInLeft" data-wow-duration="1s">{{__('Smart FSM - Field Service Management System')}}</h1>
                        <p class="wow fadeInLeft" data-wow-duration="1.5s">{{__('FSM systems facilitate better communication between the office and field staff, leading to improved productivity, customer satisfaction, and operational efficiency.')}}</p>
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                <div class="land-title">
                    ...
                    <p class="wow fadeInRight">{{__('FSM systems facilitate better communication between the office and field staff, leading to improved productivity, customer satisfaction, and operational efficiency.')}}</p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="header-detail">
                    <div>
                        <h2 class="wow fadeInUp" data-wow-duration="0.8s">500+ {{__('Clients')}}</h2>
                        <p class="wow fadeInUp" data-wow-duration="1.3s">{{__('FSM systems facilitate better communication between the office and field staff, leading to improved productivity, customer satisfaction, and operational efficiency.')}}</p><a
                    ...
                    <div class="col-lg-12 col-md-6">
                        <div class="demo-grid">
                            <div class="img-wrap"><img class="img-fluid"
                                                       ...
                                                       alt=""></div>
                            <div class="demo-detail">
                                <h3 class="text-white">{{__('Workorder Details')}}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-6">
                        <div class="demo-grid">
                            <div class="img-wrap"><img class="img-fluid"
                                                       ...
                                                       alt=""></div>
                            <div class="demo-detail">
                                <h3 class="text-white">{{__('Services & Parts')}}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-6">
