            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            {{Form::label('estimation_number_prefix',__('Estimation Number Prefix'),array('class'=>'form-label')) }}
                            {{Form::text('estimation_number_prefix',$settings['estimation_number_prefix'],array('class'=>'form-control','placeholder'=>__('Enter estimation number prefix')))}}
                        </div>
                        <div class="form-group col-md-6">
                            {{Form::label('workorder_number_prefix',__('Workorder Number Prefix'),array('class'=>'form-label')) }}
                            {{Form::text('workorder_number_prefix',$settings['workorder_number_prefix'],array('class'=>'form-control','placeholder'=>__('Enter workorder number prefix')))}}
                        </div>
                        <div class="form-group col-md-6">
