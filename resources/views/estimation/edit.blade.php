...
@section('content')
    {{ Form::model($estimation, array('route' => array('estimation.update', \Illuminate\Support\Facades\Crypt::encrypt($estimation->id)), 'method' => 'PUT')) }}
    <div class="row">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    {{Form::text('estimation_id',$estimation->estimation_id,array('class'=>'form-control','placeholder'=>__('Enter Estimation Number')))}}
                                </div>
                            </div>
                        </div>
                        <div class="form-group ">
                            {{Form::label('title',__('Title'),array('class'=>'form-label')) }} <span
        ...
        <div class="col-lg-9 col-md-9">
            ...
            <div class="row">
                <div class=" text-end">
                    {{Form::submit(__('Update'),array('class'=>'btn btn-primary btn-rounded','id'=>'estimation-submit'))}}
                </div>
            </div>
        </div>
