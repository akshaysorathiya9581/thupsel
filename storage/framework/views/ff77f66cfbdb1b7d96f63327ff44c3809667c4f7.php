<?php echo e(Form::open(array('url'=>'client','method'=>'post'))); ?>
...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('company',null,array('class'=>'form-control','placeholder'=>__('Enter company')))); ?>
    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('service_city',null,array('class'=>'form-control','placeholder'=>__('Enter service city'),'required'=>'required'))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('service_state',__('State'),array('class'=>'form-label'))); ?> <span class="text-danger">*</span>
            <?php echo e(Form::text('service_state',null,array('class'=>'form-control','placeholder'=>__('Enter service state'),'required'=>'required'))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('service_country',__('Country'),array('class'=>'form-label'))); ?> <span class="text-danger">*</span>
            <?php echo e(Form::text('service_country',null,array('class'=>'form-control','placeholder'=>__('Enter service country'),'required'=>'required'))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('service_zip_code',__('Zip Code'),array('class'=>'form-label'))); ?> <span class="text-danger">*</span>
            <?php echo e(Form::text('service_zip_code',null,array('class'=>'form-control','placeholder'=>__('Enter service zip code'),'required'=>'required'))); ?>

        </div>
        <div class="form-group col-md-12">
            <?php echo e(Form::label('service_address',__('Address'),array('class'=>'form-label'))); ?> <span class="text-danger">*</span>
            <?php echo e(Form::textarea('service_address',null,array('class'=>'form-control','rows'=>2,'placeholder'=>__('Enter service address'),'required'=>'required'))); ?>
    ...
    <div class=" col-md-12 mb-20">
        <div class="form-group">
            <div class="form-check custom-chek">
                ...
                <label class="form-check-label" for="billing_info"><h5> <?php echo e(__('Billing Address')); ?></h5></label>
            </div>
        </div>
    </div>
    <div class="row billing_info d-none">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('billing_zip_code',null,array('class'=>'form-control','placeholder'=>__('Enter billing zip code')))); ?>

        </div>
        <div class="form-group col-md-12">
            <?php echo e(Form::label('billing_address',__('Address'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::textarea('billing_address',null,array('class'=>'form-control','rows'=>2,'placeholder'=>__('Enter billing address')))); ?>
...
<?php /**PATH C:\xampp\htdocs\thupsel\resources\views/client/create.blade.php ENDPATH**/ ?>