            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('company_currency_symbol',__('Currency Icon'),array('class'=>'form-label'))); ?>

                            <?php echo e(Form::text('company_currency_symbol',$settings['company_currency_symbol'],array('class'=>'form-control','placeholder'=>__('Enter currency symbol')))); ?>
                        ...
                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('estimation_number_prefix',__('Estimation Number Prefix'),array('class'=>'form-label'))); ?>

                            <?php echo e(Form::text('estimation_number_prefix',$settings['estimation_number_prefix'],array('class'=>'form-control','placeholder'=>__('Enter estimation number prefix')))); ?>

                        </div>
                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('workorder_number_prefix',__('Workorder Number Prefix'),array('class'=>'form-label'))); ?>

                            <?php echo e(Form::text('workorder_number_prefix',$settings['workorder_number_prefix'],array('class'=>'form-control','placeholder'=>__('Enter workorder number prefix')))); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\thupsel\resources\views/settings/company.blade.php ENDPATH**/ ?>