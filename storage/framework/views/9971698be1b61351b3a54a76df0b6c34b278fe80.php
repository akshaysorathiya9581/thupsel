...
<?php $__env->startSection('content'); ?>
    <?php echo e(Form::open(array('url'=>'estimation','method'=>'post',"id"=>"estimation_form"))); ?>
    ...
    <div class="row">
                    ...
                    <div class="info-group">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <?php echo e(Form::text('estimation_id',$estimationNumber,array('class'=>'form-control','placeholder'=>__('Enter Estimation Number')))); ?>
        ...
        <div class="col-lg-9 col-md-9">
            ...
            <div class="row">
                <div class="text-end">
                    <?php echo e(Form::submit(__('Create'),array('class'=>'btn btn-primary btn-rounded','id'=>'estimation-submit'))); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\thupsel\resources\views/estimation/create.blade.php ENDPATH**/ ?>