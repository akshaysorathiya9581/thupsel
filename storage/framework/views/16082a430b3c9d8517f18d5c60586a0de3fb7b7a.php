...
<?php $__env->startSection('card-action-btn'); ?>
    <?php if(Gate::check('create service & part')): ?>
        <a class="btn btn-primary btn-sm ml-20 customModal" href="#" data-size="lg"
           ...
           data-title="<?php echo e(__('Create Service & Part')); ?>"> <i
                class="ti-plus mr-5"></i>
            <?php echo e(__('Create Service & Part')); ?>
                                    ...
                                    <div class="cart-action">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show service & part')): ?>
                                            <a class="text-warning customModal" data-bs-toggle="tooltip" data-size="lg"
                                               ...
                                               data-title="<?php echo e(__('Service & Part Detail')); ?>"> <i data-feather="eye"></i></a>
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit service & part')): ?>
                                            <a class="text-success customModal" data-bs-toggle="tooltip" data-size="lg"
                                               ...
                                               data-title="<?php echo e(__('Edit Service & Part')); ?>"> <i data-feather="edit"></i></a>
                                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/service_part/index.blade.php ENDPATH**/ ?>