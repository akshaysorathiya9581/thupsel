...
<div class="modal-body wrapper">
    ...
    <div class="service_tasks">
        <div class="row">
            <div class="col-sm-12">
                <a href="#" class="btn btn-primary btn-xs service_task_clone float-end"><i class="ti ti-plus"></i></a>
            </div>
        </div>
        <div class="row service_task">
            ...
            <div class="col-auto">
                <a href="#" class="fs-20 text-danger service_task_remove btn-sm "> <i class="ti ti-trash"></i></a>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\resources\views/service_part/create.blade.php ENDPATH**/ ?>