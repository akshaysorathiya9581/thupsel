...
<?php $__env->startSection('breadcrumb'); ?>
    <ul class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item active">
            <a href="#"><?php echo e(estimationPrefix().$estimation->estimation_id); ?></a>
        </li>
    </ul>
<?php $__env->stopSection(); ?>
<?php
...
<?php $__env->startSection('content'); ?>
    <div class="row mb-10">
        <div class="invoice-action ">
            <a class="btn btn-warning float-end print" href="javascript:void(0);"> <?php echo e(__('Print')); ?></a>
        </div>
    </div>
                        ...
                        <div id="cdx-invoice">
                            ...
                            <div class="invoice-user">
                                <div class="left-user">
                                    ...
                                    <ul class="detail-list">
                                        <li>
                                            ...
                                            <?php echo e(!empty($estimation->clients)?$estimation->clients->name:''); ?>

                                            (<?php echo e(!empty($estimation->clients) && !empty($estimation->clients->clients)?$estimation->clients->clients->company:''); ?>

                                            )
                                        </li>
                                        <li>
                                            <div class="icon-wrap"><i class="fa fa-phone"></i>
                                            </div><?php echo e(!empty($estimation->clients)?$estimation->clients->phone_number:''); ?>
                                    ...
                                    <ul class="detail-list">
                                        <li>
                                            ...
                                            <?php echo e(!empty($estimation->clients) && !empty($estimation->clients->clients)?$estimation->clients->clients->service_address:''); ?>

                                            <?php if(!empty($estimation->clients) && !empty($estimation->clients->clients) && !empty($estimation->clients->clients->service_city)): ?>
                                                <br>  <?php echo e($estimation->clients->clients->service_city); ?>

                                                ,  <?php echo e($estimation->clients->clients->service_state); ?>

                                                , <?php echo e($estimation->clients->clients->service_country); ?>,
                                                <?php echo e($estimation->clients->clients->service_zip_code); ?>
                                    ...
                                    <ul class="detail-list">
                                        <li>
                                            <div class="icon-wrap"><i class="fa fa-map-marker"></i></div>
                                            <?php echo e(!empty($estimation->clients) && !empty($estimation->clients->clients)?$estimation->clients->clients->billing_address:''); ?>

                                            <?php if(!empty($estimation->clients) && !empty($estimation->clients->clients) && !empty($estimation->clients->clients->billing_city)): ?>
                                                <br>  <?php echo e($estimation->clients->clients->billing_city); ?>

                                                ,  <?php echo e($estimation->clients->clients->billing_state); ?>

                                                , <?php echo e($estimation->clients->clients->billing_country); ?>,
                                                <?php echo e($estimation->clients->clients->billing_zip_code); ?>
                                ...
                                <div class="right-user">
                                    <ul class="detail-list">
                                        <li><?php echo e(__('Estimation No')); ?>:
                                            <span><?php echo e(estimationPrefix().$estimation->estimation_id); ?> </span></li>
                                        <li><?php echo e(__('Asset')); ?>:
                                            <span><?php echo e(!empty($estimation->assets)?$estimation->assets->name:'-'); ?> </span>
                                        </li>
                                        <li><?php echo e(__('Due Date')); ?>:
                                            <span> <?php echo e(dateFormat($estimation->due_date)); ?> </span>
                                        </li>
                            ...
                            <div class="body-invoice">
                                <div class="table-responsive1">
                                    <table class="table ml-1">
                                        ...
                                        <tbody>
                                        <?php $__currentLoopData = $estimation->services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                            ...
                            <div class="body-invoice">
                                <div class="table-responsive1">
                                    <table class="table ml-1">
                                        ...
                                        <tbody>
                                        <?php $__currentLoopData = $estimation->parts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <?php if(!empty($estimation->notes)): ?>
                                        <?php echo e(__('Notes')); ?> : <p><?php echo e($estimation->notes); ?></p>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="invoice-action">
                                    <div class="small-group">
                                        <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <input class="form-check-input estimationStatusChange" type="radio" value="<?php echo e($k); ?>"
                                                   <?php echo e(($estimation->status==$k)?'checked':''); ?> id="<?php echo e($val); ?>"
                                                   data-url="<?php echo e(route('estimation.status',$estimation->id)); ?>"
                                                   name="status"></span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/estimation/show.blade.php ENDPATH**/ ?>