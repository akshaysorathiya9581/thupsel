            ...
            var $serviceRepeater = $(serviceSelector + ' .repeater').repeater({
                ...
                hide: function (deleteEstimation) {
                    if (confirm('Are you sure you want to delete this record?')) {
                        ...
                        $.ajax({
                            url: '<?php echo e(route('workorder.service.part.destroy')); ?>',
                            type: 'DELETE',
                            headers: {
...
<?php $__env->startSection('content'); ?>
    <?php echo e(Form::model($workOrder, array('route' => array('workorder.update', \Illuminate\Support\Facades\Crypt::encrypt($workOrder->id)), 'method' => 'PUT'))); ?>
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="info-group">
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <?php echo e(Form::text('wo_id',$workOrder->wo_id,array('class'=>'form-control','placeholder'=>__('Enter Workorder Number')))); ?>

                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <?php echo e(Form::label('wo_detail',__('WO Detail'),array('class'=>'form-label'))); ?> <span
                                class="text-danger">*</span>
                            <?php echo e(Form::textarea('wo_detail',null,array('class'=>'form-control','rows'=>1,'required'=>'required'))); ?>

                        </div>
                        <div class="form-group">
                            <?php echo e(Form::label('type', __('Type'),['class'=>'form-label'])); ?> <span
                                class="text-danger">*</span>
                            <?php echo Form::select('type', $woTypes, null,array('class' => 'form-control hidesearch','required'=>'required')); ?>
                        ...
                        <div class="form-group">
                            <?php echo e(Form::label('priority', __('Priority'),['class'=>'form-label'])); ?> <span
                                class="text-danger">*</span>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <?php echo e(Form::textarea('notes',null,array('class'=>'form-control','rows'=>1))); ?>
        ...
        <div class="col-lg-9 col-md-9">
            <div class="row ">
                <div class="services">
                    <div class="card repeater " data-value='<?php echo json_encode($workOrderServices); ?>'>
                ...
                <div class="parts">
                    <div class="card repeater parts" data-value='<?php echo json_encode($workOrderParts); ?>'>
                        <div class="card-header">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\thupsel\resources\views/workorder/edit.blade.php ENDPATH**/ ?>